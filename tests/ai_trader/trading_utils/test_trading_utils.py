...
def test_aggregate_for_ai():
    ...
    # then
    assert result_str == [
        [1784505600, "1D", 10.0, 15.0, 5.0, 12.0],
        [1784678400, "1D", 20.0, 25.0, 15.0, 22.0],
        [1784937600, "1D", 30.0, 35.0, 25.0, 32.0],
        [1785240000, "1h", 10.0, 15.0, 5.0, 12.0],
        [1785250800, "1h", 20.0, 25.0, 15.0, 22.0],
        [1785261600, "1h", 30.0, 35.0, 25.0, 32.0],
        [1785294000, "15m", 10.0, 15.0, 5.0, 12.0],
        [1785301200, "15m", 20.0, 25.0, 15.0, 22.0],
        [1785308400, "15m", 30.0, 35.0, 25.0, 32.0],
        [1785316200, "5m", 10.0, 15.0, 5.0, 12.0],
        [1785316800, "5m", 20.0, 25.0, 15.0, 22.0],
        [1785317400, "5m", 30.0, 35.0, 25.0, 32.0],
        [1785318360, "1m", 10.0, 15.0, 5.0, 12.0],
        [1785318600, "1m", 20.0, 25.0, 15.0, 22.0],
        [1785319200, "1m", 30.0, 35.0, 25.0, 32.0],
    ]
